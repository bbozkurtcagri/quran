...
namespace QuranCompanion.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260620081725_AddVerseEmbeddings")]
    partial class AddVerseEmbeddings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuranCompanion.Domain.Search.VerseEmbedding", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("TranslationSourceId")
                        .HasDatabaseName("ix_verse_embeddings_translation_source_id");

                    b.HasIndex("VerseId", "TranslationSourceId", "ModelName")
                        .IsUnique()
                        .HasDatabaseName("ux_verse_embeddings_verse_source_model");

                    b.ToTable("verse_embeddings", "search");
                });
            ...
            modelBuilder.Entity("QuranCompanion.Domain.Search.VerseEmbedding", b =>
                {
                    b.HasOne("QuranCompanion.Domain.Quran.TranslationSource", "TranslationSource")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_verse_embeddings_translation_sources_translation_source_id");
                    ...
                    b.HasOne("QuranCompanion.Domain.Quran.Verse", "Verse")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_verse_embeddings_verses_verse_id");
